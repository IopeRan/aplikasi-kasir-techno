...
if(isset($_POST["save"])) {
    echo "<script>alert
         ('Pembayaran berhasil, anda akan dialihkan ke menu product');
    ...
    <body style="background-color: #e6e6e6;">
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                   <div class="bg-light rounded shadow-lg mx-auto my-5 p-3" style="width: 100%; height: 83vh;">
                       <div class="h4">Pembayaran</div>
                       <hr> 
                       <div class="d-flex flex-column">
                        <input class="rounded border shadow-lg w-100 my-1" style="border: 0;" type="text" id="product" name="product"     autocomplete="off" htmlspecialchars required placeholder="Nama Pembeli">
                        <input class="rounded border shadow-lg w-100 my-1" style="border: 0;" type="text" id="product" name="product" autocomplete="off" readonly htmlspecialchars placeholder="Tanggal Transaksi" value="<?= date('l, i-M-Y'); ?>">
                        <input class="rounded border shadow-lg w-100 my-1" style="border: 0;" type="text" id="product" name="product" autocomplete="off" readonly htmlspecialchars placeholder="Nama Produk" value="<?= $gp["produk"]; ?>">
                        <input class="rounded border shadow-lg w-100 my-1" style="border: 0;" type="number" id="harga" name="harga" autocomplete="off" readonly htmlspecialchars placeholder="Harga Produk" value="<?= $gp["harga"]; ?>">
                        <input class="rounded border shadow-lg w-100 my-1" style="border: 0;" type="number" id="total" name="total" autocomplete="off" htmlspecialchars placeholder="Total Produk" min="1" max="100" value="1">
                        <input class="rounded border shadow-lg w-100 my-1" style="border: 0;" type="text" id="hasil" name="hasil" autocomplete="off" readonly htmlspecialchars placeholder="Total Harga">
                        <button class="btn btn-primary my-1" onclick="kali()">Hitung Total</button>
                        ...
                        <button class="btn btn-danger my-1" onclick="kurang()">Hitung Kembalian</button>
                        <form action="" method="post">
                            <button class="btn btn-success my-1" id="save" name="save">Simpan Transaksi</button>
                        </form>
                       </div>
                   </div>
                </div>
