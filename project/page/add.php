    ...
    <body style="background-color: #e6e6e6;">
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                   <div class="bg-light my-5 mx-auto shadow-lg rounded p-3" style="width: 100%; height: 70vh;">
                    ...
                    <form class="d-flex flex-column" action="" method="post">
                        ...
                        <button type="submit" id="submit" name="submit" class="btn btn-success w-25">Tambah Data</button>
                    </form>
                   </div>
                </div>
            </div>
