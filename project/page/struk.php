    ...
    <body style="background-color: #e6e6e6;">
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                   <div class="bg-light container-sm mx-auto my-5 shadow-lg p-5 w-25" style="height: 70vh;">
                        <div class="h5 text-align-center"><center>Techno Cashier</center></div>
                        <div class="small mt-2">Tanggal Transaksi : <?= date('l, d-M-Y'); ?></div>
                   </div>
                </div>
            </div>
        </div>
