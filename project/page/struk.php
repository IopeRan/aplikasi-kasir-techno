...
if (!in_array("kasir", $_SESSION['admin_akses']) && !in_array("bendahara", $_SESSION['admin_akses']) && !in_array("admin", $_SESSION['admin_akses']) ) {
    echo "<script>
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Anda Tidak Memiliki Akses Sebagai Kasir Maupun Bendahara',
        }).then(() => {
